...
export default function Body({ activeRecoveries = [] }) {
  // Initialize all parts to the default color
  const colors = {
    'head': defaultColor,
    'left-shoulder': defaultColor,
    'right-shoulder': defaultColor,
    'left-arm': defaultColor,
    'right-arm': defaultColor,
    'chest': defaultColor,
    'stomach': defaultColor,
    'left-leg': defaultColor,
    'right-leg': defaultColor,
    'left-hand': defaultColor,
    'right-hand': defaultColor,
    'left-foot': defaultColor,
    'right-foot': defaultColor
  };

  if (Array.isArray(activeRecoveries)) {
    ...
    <div className="body-section">
      <div className="human-body">
        ...
        <svg 
          ...
          style={{ fill: colors['left-shoulder'] }}
        >
        ...
        <svg 
          ...
          height='46.594'
          viewBox='0 0 109.532 46.594'
          style={{ fill: colors['right-shoulder'] }}
        >
